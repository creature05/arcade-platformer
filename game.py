...
from enemies import RobotEnemy, ZombieEnemy, SuperRobot, SuperZombie
...
class MyGame(arcade.View):
    ...
    def setup(self):
        ...
        layer_options = {
            ...
            LAYER_NAME_POWER_UP: {"use_spatial_hash": True},
            LAYER_NAME_END_LEVEL: {"use_spatial_hash": True},
            LAYER_NAME_OBJECTIVE: {"use_spatial_hash": True},
            LAYER_NAME_INTERACTIVE: {"use_spatial_hash": True},
        }
    ...
    def on_update(self, delta_time):
        ...
        if (
            LAYER_NAME_ENEMIES
            or LAYER_NAME_COINS
            or LAYER_NAME_POWER_UP
            or LAYER_NAME_END_LEVEL
            or LAYER_NAME_OBJECTIVE in self.tile_map.object_lists
        ):
            ...
            for collision in player_collision_list:
                ...
                # handles changing levels
                    ...
                    if self.level < 5:
                        ...
                        self.__dict__[level_score_key] = (
                            self.__dict__.get(level_score_key, 0) + self.score
                        )
                        self.level += 1
                        self.setup()
                    else:
                        if self.objectives >= 12:
                            ...
                            pretty_bad_attempt = win_views.PrettyBadAttempt(
                                self.objectives
                            )
